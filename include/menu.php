                    ...
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            if (!empty($data['alamat'])) {
                                ...
                                echo '<p class="description-side">Bimas Hindu - Kementrian Agama </p>';
                            }
                        }
                        ?>
                    </div>
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li><a href="?page=tsm">Nota Dinas</a></li>
                                        <li><a href="?page=tsk">Surat Keputusan (SK)</a></li>
                                        <li><a href="?page=tsm">Surat Masuk</a></li>
                                        <li><a href="?page=tsk">Surat Rekomendasi</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
